...
export default function FirstAnimation() {
  ...
  return (
    <div className="group mt-6 isolate max-w-md   flex flex-col rounded-2xl bg-neutral-900 shadow-[inset_0_1px,inset_0_0_0_1px] shadow-white/[0.025]">
      {/* Description block */}
      ...
      <div className="relative min-h-[10.25rem]">
         ...
         >
           <div className="mx-auto z-10 h-60 w-[calc(294/16*1rem)] bg-gray-800 p-1.5 rounded-[calc(44/16*1rem)] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05),0_2px_5px_0_rgba(0,0,0,0.4)] [background-image:linear-gradient(rgba(255,255,255,0.05)_0%,rgba(255,255,255,0)_67.19%)]">
            <div className="relative h-[calc(200/16*1rem)] bg-gray-950/50 rounded-[calc(38/16*1rem)] px-5 pt-3 ring-1 ring-inset ring-black/5">
              <motion.div animate={{ backgroundColor: isParentHovered ? "#5DE3FF" : "" }} className="relative z-10 mx-auto flex h-6 w-6 items-center justify-center rounded-full bg-neutral-900/50">
                <LockSvg />
              </motion.div>
              <motion.span className="perspective-[1000px]">
                ...
                >
                  <div className="flex h-10 w-10 items-center justify-center rounded-[calc(10/16*1rem)] bg-gray-700 [background-image:radial-gradient(circle_at_center_top,rgba(114,233,255,0.2),rgba(114,233,255,0))] [box-shadow:rgba(255,255,255,0.05)_0px_1px_inset]">
                    <SmsIcon />
                  </div>
                  ...
                  <div className="truncate  text-xs/5 text-gray-200">
                    Your security passcode is <span className="text-white text-xs/5">764676</span>
                  </div>
                  </div>
                </motion.div>
              </motion.span>
