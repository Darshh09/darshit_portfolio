...
export const PROJECTS: Project[] = [
  {
    ...
    link: "https://react-wheel-picker.darshitdev.in",
    skills: [
      "Open Source",
      "React",
      "TypeScript",
...
`,
    logo: "https://assets.darshitdev.in/images/project-logos/react-wheel-picker.svg",
    isExpanded: true,
  },
  {
    id: "darshitdevdotcom",
    ...
    link: "https://github.com/Darshh09/darshit-portfolio",
    skills: [
      "Open Source",
      "Next.js 16",
      "Tailwind CSS v4",
  ...
  },
  {
    ...
    logo: "https://assets.darshitdev.in/images/project-logos/quaricdotcom.svg",
  },
  {
    id: "zadark",
    title: "ZaDark",
...
- Bronze Medal — 10th Design, Manufacturing, and Application Award 2022`,
    logo: "https://assets.darshitdev.in/images/project-logos/zadark.svg",
  },
  {
    id: "qabox",
    title: "QABox",
    ...
    link: "https://github.com/Darshh09/qabox",
    skills: [
      "University Project",
      "PHP",
      "MySQL",
    ...
    description:
      "- Course: Distributed Applications — FIT@HCMUS\n- Project Score: 10/10\n- Source Code: https://github.com/Darshh09/qabox",
  },
  {
    id: "taskbox",
    title: "TaskBox",
    ...
    link: "https://github.com/Darshh09/taskbox",
    skills: [
      "University Project",
      "PHP",
      "MySQL",
    ...
    description:
      "- Course: Distributed Applications — FIT@HCMUS\n- Project Score: 10/10\n- Source Code: https://github.com/Darshh09/taskbox",
  },
  {
    id: "daichat-app",
    title: "DaiChat App",
...
- Project Score: 10/10
- Source Code:
  - Server: https://github.com/Darshh09/ltudjava-summer2020-chatapp_server
  - Client: https://github.com/Darshh09/ltudjava-summer2020-chatapp_client`,
  },
  {
    id: "qlsv-app",
    title: "QLSV App",
...
- Project Score: 10/10
- Source Code: https://github.com/Darshh09/ltudjava-summer2020-hibernate`,
  },
  {
    id: "penphy",
    title: "Penphy",
...
- Pilot implemented in high schools across Can Tho City with English quizzes, supervised by English subject specialists from the Can Tho City Department of Education and Training`,
    logo: "https://assets.darshitdev.in/images/project-logos/unlimitedstudy.webp",
  },
  {
    id: "dmessage",
    title: "DMessage",
    ...
    link: "https://github.com/Darshh09/DMessage",
    skills: [
