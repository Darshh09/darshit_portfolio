...
export const FloatingDock = ({
  ...
  return (
    <>
      {/* Blur overlay for content behind dock */}
      <div className="fixed bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-black/30 to-transparent backdrop-blur-sm pointer-events-none z-40" />
  ...
  return (
    <div className={cn("relative block md:hidden", className)}>
      ...
      <button
        ...
        className="flex h-12 w-12 items-center justify-center rounded-full bg-cardColor border border-white/20 shadow-lg hover:bg-cardColorForeground transition-colors"
      >
...
function IconContainer({
  ...
  // Check if the link is external (starts with http/https or is a file download)
